        ...
        <>
            <div className='UploadBody'>
                ...
                <div className="UploadInfo">
                    <form action="" className="UploadTitleForm">

                        <label for="" className="label">
                            <div>제목: </div>
                            <div className='MovieTitleInputDiv'>
                                <input type="text" name="" id="" required className='MovieTitleInput' />
                    ...
                    <form action="" className="UploadInfoForm">
                        <label for="">
                            <div>감독: </div>
                            <div>
                                <input type="text" name="" id="" required className='MovieUploadInput' />
                            </div>
                        </label>
